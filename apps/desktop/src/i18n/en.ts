...
export const en: Translations = {
  ...
  rightSidebar: {
    ...
    resizePanelSplit: 'Resize panel split',
    refreshChanges: 'Refresh source control',
    sourceControlUnavailable: 'Source control unavailable',
    notGitRepository: 'No Git repository',
    notGitRepositoryBody: 'The current folder is not inside a Git repository.',
    noChanges: 'No changes',
    noChangesBody: 'The working tree is clean.',
