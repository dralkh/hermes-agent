...
export const zhHant = defineLocale({
  ...
  rightSidebar: {
    ...
    dropPanelHere: '將面板拖放到此處',
    resizePanelSplit: '調整面板分割大小',
    refreshChanges: '重新整理原始碼管理',
    sourceControlUnavailable: '原始碼管理不可用',
    notGitRepository: '沒有 Git 儲存庫',
    notGitRepositoryBody: '目前資料夾不在 Git 儲存庫中。',
    noChanges: '沒有變更',
    noChangesBody: '工作樹是乾淨的。',
    mergeChanges: '合併變更',
