...
export const zh: Translations = {
  ...
  rightSidebar: {
    ...
    dropPanelHere: '将面板拖放到此处',
    resizePanelSplit: '调整面板拆分大小',
    refreshChanges: '刷新源代码管理',
    sourceControlUnavailable: '源代码管理不可用',
    notGitRepository: '没有 Git 仓库',
    notGitRepositoryBody: '当前文件夹不在 Git 仓库中。',
    noChanges: '没有更改',
    noChangesBody: '工作树是干净的。',
    mergeChanges: '合并更改',
    stagedChanges: '暂存的更改',
    changes: '更改',
